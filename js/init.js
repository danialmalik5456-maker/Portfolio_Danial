...
function ryker_tm_modalbox_projects(){
	
	"use strict";
	
	var modalBox	= jQuery('.ryker_tm_modalbox');
	var button		= jQuery('.ryker_tm_projects .popup_info');
	
	button.on('click',function(){
		var element 	= jQuery(this);
		var parent		= element.closest('li');
		var details 	= parent.find('.projects_hidden_infos').html();
		...
		modalBox.find('.projects_main_title').html(titles);
